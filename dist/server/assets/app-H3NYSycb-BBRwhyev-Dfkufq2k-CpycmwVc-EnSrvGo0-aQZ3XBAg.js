import { Y as reactExports, P as jsxRuntimeExports, O as Outlet, ab as useRouter } from "./server-AHFj_Bgy-gsoihpy4-CbyuSDu4-Ble6ghI2-BbTWyedm-DMY4rmEE.js";
import { u as useNavigate, o as useQueryClient, L as Link } from "./router-BfE_NWn3-LgtRmdPD-C07lmE3T-BBvol4Fb-CaQxh4DF-DI3ZXuwt.js";
import { B as Button, S as Slot$1, a as cva, c as createSlot$1 } from "./button-DA2gxxPy-CUtl2pTC-ErPINpYe-DKbncp_B-Tad0GHuE-BV1-pB3e.js";
import { a as cn } from "./utils-H80jjgLf-8RO4xBwZ-8RO4xBwZ-8RO4xBwZ-8RO4xBwZ-8RO4xBwZ.js";
import { I as Input } from "./input-C0QjszdI-D0Nowbjj-BlGc600N-CG6Wsqmc-CIMgTJSL-CX_fTxgv.js";
import { d as Root$1, P as Portal$2, a as Content, C as Close, T as Title, D as Description, c as Portal$1$1, O as Overlay, h as hideOthers, R as ReactRemoveScroll, b as DismissableLayer, u as useFocusGuards, F as FocusScope } from "./index-BPTzbsrp-DhwZnvmV-BfJgqgod-B4ke32GD-CzpO3NTa.js";
import { u as useControllableState, f as useId, a as Primitive$1, c as composeEventHandlers, P as Presence, d as createContextScope } from "./index-CT_HDpbD-DFZI880l-DNpWO7Mr-BdyN3wdT-jJeE0WN7.js";
import { u as useComposedRefs, c as composeRefs } from "./index-QcqZe4R0-BtpN0_mD-B-IZFptm-RV47Io5--BsvVBnmG.js";
import { b as Root2$1, A as Anchor, c as createPopperScope, C as Content$1, R as Root$2, a as Arrow } from "./index-Cj6RN1ru-pIt5HwOm-Bjjs2k74-DWZhJhxN-CobipNTR.js";
...
import { A as Avatar, a as AvatarFallback } from "./avatar-BJDbbUeP-CZmtsF0U-C3neXmDb-xwiqNsUW-RiASFovh-DO1KW8Hl.js";
...
import { X } from "./x-g8BMWhwB-DMM2ctZM-DGRCVHHF-Dd1IC55S-rAyy0ZEZ.js";
import { C as CircleAlert } from "./circle-alert-COmp4TT0-D7hD_4OR-DcEhy-Bm-5TL82XrJ-D3WYzjLm.js";
import { U as Users } from "./users-BHKbGGRE-Cok5gXfN-ChM9mb55-D6nOO-Pu-CsVUTUnB.js";
...
const CalendarOff = createLucideIcon("calendar-off", __iconNode$7);
const __iconNode$6 = [
...
var TooltipPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider$1, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1$1, { asChild: true, container, children }) }) });
};
...
var PopoverPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1$1, { asChild: true, container, children }) }) });
};
...
const operacao = [
  ...
  { title: "Ocorrências", url: "/app/ocorrencias", icon: CircleAlert },
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app", className: "flex items-center gap-2 px-2 py-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { className: collapsed ? "[&>span:last-child]:hidden" : "" }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SidebarMenuButton,
      {
        onClick: () => {
        ...
        children: [
          ...
          !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sair da conta" })
        ]
      }
    ) }) }) })
  ] });
...
function AppHeader() {
  ...
  const [notificacoes, setNotificacoes] = reactExports.useState([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-background px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: headerLabel })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "icon", className: "relative", children: [
          ...
          notificacoes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-destructive" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-80 p-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium", children: "Notificações" }),
            notificacoes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: marcarTodasComoLidas, className: "text-xs text-turno-700 hover:underline", children: "Marcar como lidas" })
          ] }),
          notificacoes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-8 text-center text-sm text-muted-foreground", children: "Nenhuma notificação por enquanto." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "max-h-80 divide-y overflow-y-auto", children: notificacoes.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex gap-3 px-4 py-3 hover:bg-muted/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 text-[11px] text-muted-foreground", children: n.time })
          ] }) }, n.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded-full focus:outline-none focus:ring-2 focus:ring-turno-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-turno-100 text-xs text-turno-900", children: initials || "U" }) }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-60 p-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium", children: nome || "Usuário" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "truncate text-xs text-muted-foreground", children: email })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "py-1 text-sm", children: [
