import { g as compileDecodeCharMap, j as createLRUCache, a7 as trimPath, a4 as rewriteBasepath, h as composeRewrites, X as processRouteTree, W as processRouteMasks, a3 as resolvePath, e as cleanPath, a9 as trimPathRight, i as createControlledPromise, V as parseHref, s as executeRewriteInput, H as isDangerousProtocol, Z as redirect, L as isRedirect, J as isNotFound, w as findSingleMatch, n as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, F as interpolatePath, U as nullReplaceEqualDeep, $ as replaceEqualDeep$1, Q as last, m as decodePath, u as findFlatMatch, x as functionalUpdate$1, v as findRouteMatch, K as isPromise, G as invariant, a5 as rootRouteId, ab as useRouter, P as jsxRuntimeExports, O as Outlet, E as hasKeys, t as executeRewriteOutput, c as arraysEqual, Y as reactExports, R as React, r as exactPathTest, _ as removeTrailingSlash, I as isModuleNotFoundError, M as isServer$1, o as dummyMatchContext, S as matchContext, q as escapeHtml, y as getAssetCrossOrigin, B as getScriptPreloadAttrs, b as appendUniqueUserTags, aa as useHydrated, a8 as trimPathLeft, N as joinPaths, a2 as resolveManifestCssLink, p as encodePathLikeUrl, a1 as requireReactDom, z as getDefaultExportFromCjs } from "./server-AHFj_Bgy-gsoihpy4-CbyuSDu4-Ble6ghI2-BbTWyedm-DMY4rmEE-B4C4KxOU.js";
import { s as supabase } from "./client-BDUtUdlc-BgkiGMRQ-BFQ4tIWJ-OPLCuHla-DDf4-v7v-Dm7zLGxE-XTdH44OP.js";
import { Stripe } from "./stripe.esm.worker-BZ5uBE48-BZ5uBE48-BZ5uBE48-BZ5uBE48-BZ5uBE48-BZ5uBE48.js";
import { c as createClient } from "./index-BlRNeFf7-93iW_Z4T-93iW_Z4T-93iW_Z4T-93iW_Z4T-93iW_Z4T.js";
...
const appCss = "/assets/styles-CvAx2N-l.css";
...
const $$splitComponentImporter$k = () => import("./test-checkout-C31EvX_5-CuXsf4eF-BJ09gIHQ-MG6ikb1A-CdRr0Q5Z-B0buCIQQ-CoUHBS-x.js");
const Route$l = createFileRoute("/test-checkout")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./termos-Dr4Z50Du-B2GL-9X6-Ctvvx86_-BfAvj950-5_AbYqyz-wBNrU6sg-PPVwtfa1.js");
...
const $$splitComponentImporter$i = () => import("./suporte-DBVpQpso-BbyS31pl-DbJhKSXs-BCDtu45E-DY5U7QRZ-BYH107SN-BuBaEEO5.js");
const Route$j = createFileRoute("/suporte")({
...
const $$splitComponentImporter$h = () => import("./privacidade-DyOWlDGw-gYcOPao9-gDgdKI2D-DJ0t-DDF-BdeksHfz-CSYcDZEb-CoIWBdaR.js");
const Route$i = createFileRoute("/privacidade")({
...
const $$splitComponentImporter$g = () => import("./pagamento-BPK0RIkD-BBII4JvZ-ipZQUsa6-DaVuMONF-BtiGHQ9k-_uwMVlgj-n10ydlTJ.js");
const Route$h = createFileRoute("/pagamento")({
...
const $$splitComponentImporter$f = () => import("./onboarding-Bx_M-eze-CVt6HnLv-D02VZ3C--DqU66XZJ-DUKzj4B5-2AYUUa1g-DUFMbmnL.js");
const Route$g = createFileRoute("/onboarding")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./login-CoHR4G49-HvTPvZQg-B3LQWuMS-B7mslwjS-C3VFTKcu-7exdeZe3-D__pqxem.js");
...
const $$splitComponentImporter$d = () => import("./contato-DAOow8GW-pK4smu7X-QN-lxPft-CXOo-zs4-BNg25zJ3-BOI5WeT4-BvCpiPoo.js");
...
const $$splitComponentImporter$c = () => import("./confirmar-C76SWxsQ-wUDO75Nf-BDOFZUpJ-DvktTlI8-CcQ5fYM7-D93oHu8P-6oJGepjP.js");
const Route$d = createFileRoute("/confirmar")({
...
const $$splitComponentImporter$b = () => import("./app-H3NYSycb-BBRwhyev-Dfkufq2k-CpycmwVc-EnSrvGo0-aQZ3XBAg-DIBGScBd.js");
const Route$c = createFileRoute("/app")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-B61Px7mD-fx0p7f7y-PigCJfI4-BizPsfS6-CmoWrrGP-p3jKWkca-nyq1AfjS.js");
const Route$b = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./app.index-DKHFEdMd-ByuIgNBX-BG0F9vjB-dck1JOqV-BZFNDsY8-BnbFAIfA-grXcr66p.js");
const Route$a = createFileRoute("/app/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./app.turnos-D0ggf3p1-BqkEcWxJ-DD9PX8q5-BB-4nm6a-DtifNRo2-CVk4OQKd-CvLcb39k.js");
const Route$9 = createFileRoute("/app/turnos")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./app.plano-BTn4n1dT-Da1_NpbA-mxqPpnsF-BdQ7n92Q-DLbjw1sQ-CAAhNb4a-wisQ52T6.js");
const Route$8 = createFileRoute("/app/plano")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./app.ocorrencias-DKo8u7zF-WLQ_vwGZ-Iy9dNY6d-ClPpo75t-Cf8bz9ND-CxmtONbS-Bud03MD0.js");
const Route$7 = createFileRoute("/app/ocorrencias")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./app.notas-5TvsXgBX-Be7-ABOU-DueMQkh4-B7AvjuYY-CoEcWrxg-DLMro4TA-VZiCMQlP.js");
const Route$6 = createFileRoute("/app/notas")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./app.membros-DHn-zzbi-CZSYJMWe-D0wMCsMC-B__-hO4G-F-eL6Fr5-dFhufFKs-DavY7-j6.js");
const Route$5 = createFileRoute("/app/membros")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./app.historico-BxeH1qa4-CyVtUWBe-BEvtjuMt-D1UK_iuv-BvIEX81c-D_Ouhzj4-ureqQ0Y4.js");
const Route$4 = createFileRoute("/app/historico")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./app.folgas-Cpp_siKB-DfpgOI67-COpBfMst-Dyjf_vl3-KAg5gly0-CVotR3fs-jY9VZtQ8.js");
const Route$3 = createFileRoute("/app/folgas")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./app.configuracoes-BvZ4jMim-A6vjpEjQ-BVDzWBdd-BvFJs9-6-gzgIvReE-BNnE1Akq-DmfSaCQm.js");
const Route$2 = createFileRoute("/app/configuracoes")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./app.cargos-DsYZ407S-BM0I59Sw-bHT05QkB-BjTI8sNs-3_n9m1ud-DCib9VVI-BXYuvF-d.js");
const Route$1 = createFileRoute("/app/cargos")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const PRICE_KEY_TO_PLANO = {
...
const Route2 = createFileRoute("/api/webhooks/stripe")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          switch (event.type) {
            case "checkout.session.completed": {
              ...
              await supabase2.from("assinaturas").upsert(
                {
                  user_id: userId,
                  ...
                  trial_end: subscription.trial_end ? new Date(subscription.trial_end * 1e3).toISOString() : null,
            ...
            case "customer.subscription.deleted": {
              ...
              const plano = PRICE_KEY_TO_PLANO[lookupKey] ?? "gratis";
              const periodo = PRICE_KEY_TO_PERIODO[lookupKey] ?? "mensal";
              await supabase2.from("assinaturas").update({
                plano,
                periodo,
                status: subscription.status,
                current_period_end: new Date(
...
const TestCheckoutRoute = Route$l.update({
  id: "/test-checkout",
  path: "/test-checkout",
...
const SuporteRoute = Route$j.update({
  id: "/suporte",
  path: "/suporte",
  getParentRoute: () => Route$m
});
const PrivacidadeRoute = Route$i.update({
  id: "/privacidade",
  path: "/privacidade",
  getParentRoute: () => Route$m
});
const PagamentoRoute = Route$h.update({
  id: "/pagamento",
  path: "/pagamento",
  getParentRoute: () => Route$m
});
const OnboardingRoute = Route$g.update({
  id: "/onboarding",
  path: "/onboarding",
  getParentRoute: () => Route$m
});
...
const ConfirmarRoute = Route$d.update({
  id: "/confirmar",
  path: "/confirmar",
  getParentRoute: () => Route$m
});
...
const AppTurnosRoute = Route$9.update({
  id: "/turnos",
  path: "/turnos",
  getParentRoute: () => AppRoute
});
const AppPlanoRoute = Route$8.update({
  id: "/plano",
  path: "/plano",
  getParentRoute: () => AppRoute
});
const AppOcorrenciasRoute = Route$7.update({
  id: "/ocorrencias",
  path: "/ocorrencias",
  getParentRoute: () => AppRoute
});
const AppNotasRoute = Route$6.update({
  id: "/notas",
  path: "/notas",
  getParentRoute: () => AppRoute
});
const AppMembrosRoute = Route$5.update({
  id: "/membros",
  path: "/membros",
  getParentRoute: () => AppRoute
});
const AppHistoricoRoute = Route$4.update({
  id: "/historico",
  path: "/historico",
  getParentRoute: () => AppRoute
});
const AppFolgasRoute = Route$3.update({
  id: "/folgas",
  path: "/folgas",
  getParentRoute: () => AppRoute
});
const AppConfiguracoesRoute = Route$2.update({
  id: "/configuracoes",
  path: "/configuracoes",
  getParentRoute: () => AppRoute
});
const AppCargosRoute = Route$1.update({
  id: "/cargos",
  path: "/cargos",
  getParentRoute: () => AppRoute
});
const ApiWebhooksStripeRoute = Route2.update({
...
const routerBfE_NWn3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getRouter
