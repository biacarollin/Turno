...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BJwkQpTw-BJwkQpTw.js");
...
const manifest = {
  "25257d290f80a1a900f15a88549a5603b8717ded10882ffd3b0c64a41e187be5": {
    functionName: "excluirOrganizacao_createServerFn_handler",
    importer: () => import("./organizacao.functions-DySdWBOi-Cg1aPhUG.js")
  },
  "31c91f8a38c7ea71224838a0e541df70a111114c86307552a8c887a0e72e363a": {
    functionName: "criarPortalStripe_createServerFn_handler",
    importer: () => import("./stripe-portal-xRJ_kCt--Cpi18BDr.js")
  },
  "93a804ab06e45560dbb0c5e1f040dd61608b70d51751ea73b7cd35e81d73536d": {
    functionName: "createCheckoutSession_createServerFn_handler",
    importer: () => import("./checkout-BM2ovHkr-D44Nn49c.js")
  },
  "d15872a4196c7ae553c251f4edadd2df28a3050343507e270cc5d90fdfb07f81": {
    functionName: "buscarAssinatura_createServerFn_handler",
    importer: () => import("./buscar-assinatura-D4fcXd6_-DCwCPFwp.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bpeyu-Rv-V2oQ01bo.js").then((n2) => n2.k),
    import("./start-CwNWqYIk-C0S_EFM0.js"),
    import("./empty-plugin-adapters-BFgPZ6_d-BFgPZ6_d.js")
  ]);
  return {
    routerEntry,
    startEntry,
...
const serverDznBcuRC = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
