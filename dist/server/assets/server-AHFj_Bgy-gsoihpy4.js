...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DP_bkW4X-DP_bkW4X.js");
...
const manifest = {
  "25257d290f80a1a900f15a88549a5603b8717ded10882ffd3b0c64a41e187be5": {
    ...
    importer: () => import("./organizacao.functions-B9xqQQO3-DNRMmcA4.js")
  },
  "93a804ab06e45560dbb0c5e1f040dd61608b70d51751ea73b7cd35e81d73536d": {
    ...
    importer: () => import("./checkout-ClmQaeg1-2e2F_oka.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BfE_NWn3-LgtRmdPD.js").then((n2) => n2.k),
    import("./start-BVmqdM92-B41U0Y2Y.js"),
