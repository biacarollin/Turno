...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DqqjAC5t.js");
...
const manifest = {
  "25257d290f80a1a900f15a88549a5603b8717ded10882ffd3b0c64a41e187be5": {
    ...
    importer: () => import("./organizacao.functions-BUMVe4dy.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-HB4it8k7.js"),
    import("./start-C6cxHdM7.js"),
